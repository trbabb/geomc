...
namespace geom {
    ...
    public:
        ...
        using detail::VecCommon<T,2,Vec<T,2>>::operator==;
        ...
        constexpr Vec():detail::VecCommon< T, 2, Vec<T,2> >() {}
        
        /// Construct a vector with both elements set to `a`.
        constexpr Vec(T a):detail::VecCommon< T, 2, Vec<T,2> >(a) {}
        ...
        constexpr Vec(const T v[2]):detail::VecCommon< T, 2, Vec<T,2> >(v){}
